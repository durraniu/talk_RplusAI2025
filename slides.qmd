...
p11 <- p1 + scale_color_paletteer_d(palette = "khroma::dark", dynamic = 
FALSE)
...
p33 <- p3 + scale_color_paletteer_c(palette = "scico::hawaii")
...
p66 <- p6 + scale_fill_paletteer_c(palette = "scico::vik")
...
> Here are your requested color palettes:
Discrete: "#1F407A" "#78D32D" "#FDD60A" "#9A4665" "#8A2BE2" "#008080"
Sequential: "#F0F8FF" "#B0C4DE" "#8DA0C8" "#6C7BAF" "#4B5696" "#2F367F"
...
...
p111 <- p1 + scale_color_manual(values = cp$discrete1)
p333 <- p3 + scale_fill_gradientn(colors = cp$sequential1)
p666 <- p6 + scale_fill_gradientn(colors = cp$diverging1)

combined2 <- p111 + p333 + p666 
...
```{r}
#| eval: false
#| code-line-numbers: 1-3|5-10|12-16|18-48|18|19|20-23|44-47|50-54
...
- 🔄 **Consistent**: One file for all projects
- 🤖 **Smart**: AI understands design principles
:::


## And done!

![](https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExMWtpb2FhZTdhZHQ0NmVnMWIzcnAxYTJ0Z25lODRkOGhrbGI2c3l4YiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/JFyH9XrzZh9pAjx1HN/giphy.gif)
...
- 📧 GitHub: @durraniu
- 🦋 Bluesky: @transport-talk.bsky.social
- 📦 Package: github.com/durraniu/brandthis
